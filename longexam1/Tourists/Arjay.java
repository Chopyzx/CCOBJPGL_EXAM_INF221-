...
public class Arjay implements Tourist {
    ...
    public void visit(Boracay boracay) {
        ...
        if ( budget > boracay.airFare  ){
            System.out.println("forda gala" );
            budget -= boracay.airFare;

        }else{
            System.out.println("somg wala nako pera");
        }
    ...
    public void visit(Siargao siargao) {
        if(budget >siargao.airFare){
            System.out.println("what if siargao!");
    ...
    public void visit(Vigan vigan) {
        if(budget >vigan.airFare){
            System.out.println("next trip vigan! ");
